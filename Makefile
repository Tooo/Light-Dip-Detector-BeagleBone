...
CFILES_1 = main.c samplerThread.c dipDetector.c potToSize.c outputThread.c udpListener.c system.c shutdownManager.c circularBuffer.c periodTimer.c lightSensor.c potentiometer.c ledDisplay.c
